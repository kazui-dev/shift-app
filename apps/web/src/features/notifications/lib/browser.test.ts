...
import { getPushConfig } from "@/features/notifications/api/push"
import {
  pushSupported,
...
vi.mock("@/features/notifications/api/push", async (original) => ({
  ...(await original<typeof import("@/features/notifications/api/push")>()),
